  ...
  return (
    <div className='p-4 '>
      <div className='flex items-center flex-col'>
        <div className='text-4xl p-4'>Your Journals Begins Here !</div>
        <div className='flex flex-col gap-y-[2rem] w-[80%] mt-[1rem] items-center '>
          <div className='relative w-full sm:w-[70%]'>
            ...
            />
            <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-red-500 peer-focus:text-sm">Title</label>
          </div>
          <div className='relative w-full sm:w-[70%]'>
            ...
            />
            <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-red-500 peer-focus:text-sm">Description</label>

          </div>
          <div className='w-full sm:w-[70%] flex flex-col items-start gap-4 text-lg m-2'>
            <div className='flex justify-between w-full items-center'>
              <button onClick={handleGenerate} className='flex items-center gap-x-[0.5rem] bg-red-400 p-[0.5rem] rounded-md  '>
          ...
          <div className='flex w-full sm:w-[70%] flex-col sm:flex-row'>
            <div className='relative w-full sm:w-[50%] flex flex-col items-start gap-4 text-lg m-2'>
              ...
              />
              <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-red-500 peer-focus:text-sm">Author</label>
            </div>
            <div 
              ...
              >
                ...
                >
                  <label className="absolute left-0 -top-8 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-red-500 peer-focus:text-sm">
                    Upload Image
                  </label>
          ...
          <button className='bg-red-400 px-3 py-3 rounded-lg mt-7 text-2xl shadow-xl' onClick={handleSubmit}>Add Journal</button>
        </div>
      </div>
      <ToastContainer />
    </div>
